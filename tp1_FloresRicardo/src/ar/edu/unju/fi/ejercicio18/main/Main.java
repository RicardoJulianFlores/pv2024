...
public class Main {
	...
	public static void main(String[] args) {
		...
		switch(op) 
		{
			...
			case "3": modDestino(destinos,paises);
					  break;
			case "4": destinos.clear();
					  System.out.println("Lista de destino limpiada");
					  break;
	...
	public static void modDestino(List<DestinoTuristico> destinos, List<Pais> paises) {
		Scanner sc = new Scanner(System.in);
		int codigo;
		System.out.print("Ingrese Codigo Numerico del Destino a cambiar: ");
		codigo=sc.nextInt();
		for(DestinoTuristico d: destinos) {
...
public static void mostrarDtdePais(List<DestinoTuristico> destinos) {
	...
	codigo=sc.nextLine();
	System.out.println("Destinos de "+codigo);
	for(DestinoTuristico d: destinos) {
